...
<header>
    ...
    <script> 
        ...
        var tiles = L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
            maxZoom: 19,
            attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> | <a href="https://bali.bps.go.id/id/statistics-table/1/NDcjMQ==/luas-wilayah-nama-ibukota-kabupaten-kota-dan-jumlah-pulau-menurut-kabupaten-kota-di-bali-2022.html">BPJS di Provinsi Bali Kab/Kota (Luas Wilayah)</a>'
        }).addTo(map);
        ...
        function getColor(d) {
    return d > 1231.30 ? '#800026' : // Warna merah tua untuk nilai sangat tinggi
           d > 1093.36 ? '#BD0026' : // Warna merah gelap
           d > 955.42  ? '#E31A1C' : // Warna merah terang
           d > 817.48  ? '#FC4E2A' : // Warna oranye tua
           d > 679.54  ? '#FD8D3C' : // Warna oranye terang
           d > 541.60  ? '#FEB24C' : // Warna kuning-oranye
           d > 403.66  ? '#FED976' : // Warna kuning terang
           d > 265.72  ? '#FFEDA0' : // Warna kuning pucat
                         '#FFFFFF';  // Warna putih untuk nilai sangat rendah
}
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Luas Wilayah di Kab/Kota Bali</h4>' +  (props ?
                '<b>' + props.name + '</b><br />' + props.luas.toLocaleString('id-ID') + ' km²'
                : 'Hover over a state');
        };
        ...
        legend.onAdd = function (map) {
            ...
            var div = L.DomUtil.create('div', 'info legend'),
                grades = [0, 265.72, 403.66, 541.60, 679.54, 817.48, 955.42, 1093.36, 1231.30],
                labels = [];
