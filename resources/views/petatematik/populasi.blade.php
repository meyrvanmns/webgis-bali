...
<header>
    ...
    <script> 
        ...
        var tiles = L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
            maxZoom: 19,
            attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> | <a href="https://id.wikipedia.org/wiki/Bali">Wikipedia di Provinsi Bali Kab/Kota (Jumlah Penduduk)</a>'
        }).addTo(map);
        ...
        function getColor(d) {
    return d > 646231 ? '#8B0000' : // Merah pekat untuk nilai tinggi
        d > 593298  ? '#B22222' :
        d > 540365  ? '#DC143C' :
        d > 487432  ? '#FF0000' :
        d > 434498  ? '#FF6347' :
        d > 381564  ? '#FF7F50' :
        d > 328630  ? '#FF4500' :
        d > 275696  ? '#FF6347' : // Merah muda terang untuk nilai rendah
                        '#FA8072';  // Merah muda paling terang untuk nilai terkecil
}
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Populasi Penduduk di Kab/Kota Bali</h4>' +  (props ?
        ...
        legend.onAdd = function (map) {
            ...
            var div = L.DomUtil.create('div', 'info legend'),
                grades = [0, 275696, 328630, 381564, 434498, 487432, 540365, 593298, 646231],
                labels = [];
