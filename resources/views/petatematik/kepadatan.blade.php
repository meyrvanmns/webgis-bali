...
<header>
    ...
    <script> 
        ...
        var tiles = L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
            maxZoom: 19,
            attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> | <a href="https://bali.bps.go.id/id/statistics-table/3/V1ZSbFRUY3lTbFpEYTNsVWNGcDZjek53YkhsNFFUMDkjMw==/penduduk-laju-pertumbuhan-penduduk-distribusi-persentase-penduduk-kepadatan-penduduk-rasio-jenis-kelamin-penduduk-menurut-kabupaten-kota-di-provinsi-bali.html?year=2022">BPJS di Provinsi Bali Kab/Kota (Kepadatan Penduduk)</a>'
        }).addTo(map);
        ...
        function getColor(d) {
    return d > 1900  ? '#00CED1' : // Biru Tuwir
           d > 1400  ? '#20B2AA' : // Biru Hijau Muda
           d > 900   ? '#48D1CC' : // Biru Laut Terang
                       '#AFEEEE'; // Biru Pucat
}
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Kepadatan Penduduk di Kab/Kota Bali</h4>' +  (props ?
                '<b>' + props.name + '</b><br />' + props.kepadatan.toLocaleString('id-ID') + ' jiwa/km²'
                : 'Hover over a state');
        };
        ...
        legend.onAdd = function (map) {
            ...
            var div = L.DomUtil.create('div', 'info legend'),
                grades = [0, 900, 1400, 1900, 2400, 2900, 3400, 4400, 5500],
                labels = [];
