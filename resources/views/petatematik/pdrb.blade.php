...
<head>
    ...
    <title>Produk Domestik Regional Bruto - Perkapita (PDRB)</title>
...
<header>
    ...
    <script> 
        ...
        var tiles = L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
            maxZoom: 19,
            attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> | <a href="https://bali.bps.go.id/id/statistics-table/2/MTcyIzI=/pdrb-perkapita-atas-dasar-harga-berlaku-kabupaten-kota-di-provinsi-bali.html">BPJS di Provinsi Bali Kab/Kota (PDRB)</a>'
        }).addTo(map);
        ...
        function getColor(d) {
            return d > 61373 ? '#8B5E00' :  // Warna kuning pekat
                d > 55256 ? '#B77D00' :  // Warna kuning gelap
                d > 49139 ? '#D79C00' :  // Warna kuning keemasan
                d > 43022 ? '#F4BB00' :  // Warna kuning cerah
                d > 36905 ? '#FFCC33' :  // Warna kuning terang
                d > 30788 ? '#FFDD66' :  // Warna kuning lebih terang
                d > 24671 ? '#FFE699' :  // Warna kuning pucat
                d > 18554 ? '#FFF2CC' :  // Warna kuning sangat pucat
                            '#FFFFE0';  // Warna kuning sangat terang (paling rendah)
        }
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Produk Domestik Regional Bruto - Perkapita (PDRB) di Kab/Kota Bali</h4>' +  (props ?
                '<b>' + props.name + '</b><br />' + props.pdrb.toLocaleString('id-ID') + ' perkapita'
                : 'Hover over a state');
        };
        ...
        legend.onAdd = function (map) {
            ...
            var div = L.DomUtil.create('div', 'info legend'),
                grades = [0, 18554, 24671, 30788, 36905, 43022, 49139, 55256, 61373],
                labels = [];
